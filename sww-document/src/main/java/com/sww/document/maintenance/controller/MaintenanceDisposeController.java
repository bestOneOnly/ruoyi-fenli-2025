...
@RestController
@RequestMapping("/document/maintenance/dispose")
@RequiredArgsConstructor
public class MaintenanceDisposeController extends BaseController {
    ...
    private final IMaintenanceService maintenanceService;
      ...
      */
    @PostMapping("/handle")
    public AjaxResult dispose(@RequestBody @Validated MaintenanceDisposeReq req){
        return toAjax(maintenanceFactory.getHandler(MaintenanceAction.DISPOSE).handle(req));
    }
    ...
    public TableDataInfo list(MaintenanceQueryReq req){
        // 分页查询
        startPage();
        List<Maintenance> list = maintenanceService.queryList(req, MaintenancePageQuery.PAGE_DISPOSE);
